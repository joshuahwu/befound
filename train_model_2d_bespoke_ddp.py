...
def main():
    ...
    parser = argparse.ArgumentParser(prog="Behavioral Foundation Models Train (Bespoke DDP)", description="Train Behavioral Foundation Models (Bespoke DDP)")
...
# torchrun --nproc_per_node=NUM_GPUS train_model_2d_bespoke_ddp.py -p f_vae -n 2d_bespoke_mabe
